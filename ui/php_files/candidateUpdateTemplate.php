<?php
	...
	$sql = mysqli_query($conn, "SELECT * from candidate where candidateId = '$id'");
	...
	if ($_POST['identification'] == 'junior') {
		...
		include '../../pages/junior-edit.php';

	}


	elseif ($_POST['identification'] == 'senior') {
		include '../../pages/senior-edit.php';
	}


	elseif ($_POST['identification'] == 'college') {
		
		include '../../pages/college-edit.php';
